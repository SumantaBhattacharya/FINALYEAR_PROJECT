...
const Testimonials = () => {
  ...
  return (
    <div className="flex flex-col items-center px-6 md:px-16 lg:px-24 bg-gray-400 pt-20 pb-30 mb-20">
      <div className="flex flex-col justify-center items-center text-center">
        <h1 className="text-4xl md:text-[40px] font-playfair">Customer Testimonials</h1>
      ...
      <div className="flex flex-wrap items-center justify-center gap-6 mt-20 mb-10">
        {testimonials.map((testimonial) => (
          <div key={testimonial.id} className="bg-gray-200 p-6 rounded-xl shadow max-w-xs">
